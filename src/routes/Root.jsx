...
export default function Root() {
  ...
  const onHover = (index) => {
    setHover((prevHover) => prevHover.map((h, i) => (i === index ? !h : h)));
  };
    ...
    <div>
      ...
      <main id="main">
        <section className="Skills">
          <h1>
            <span className="tech_stack skill-style">Techstack</span>
          </h1>
          <div className="skill">
            <ul>
              <li
              ...
              >
                ...
                {hover[0] && <p className="skill-style">HTML</p>}
              </li>
              <li
                style={{ position: "relative" }}
              ...
              >
                ...
                {hover[2] && <p className="skill-style">JavaScript</p>}
              </li>
              <li
                style={{ position: "relative" }}
              ...
              >
                ...
                {hover[3] && <p className="skill-style">React</p>}
              </li>
            </ul>
          </div>
          <div className="skill_two">
            <ul>
              ...
              >
                ...
                {hover[4] && <p className="skill-style">Node</p>}
              </li>
              <li
                style={{ position: "relative" }}
              ...
              >
                ...
                {hover[5] && <p className="skill-style">Express</p>}
              </li>
              <li
                style={{ position: "relative" }}
              ...
              >
                ...
                {hover[6] && <p className="skill-style">MariaDB</p>}
              </li>
              <li
                style={{ position: "relative" }}
              ...
              >
                ...
                {hover[7] && <p className="skill-style">MongoDB</p>}
              </li>
              <li
                style={{ position: "relative" }}
              ...
              >
                ...
                {hover[8] && <p className="skill-style">Mongoose</p>}
              </li>
            </ul>
          </div>
        </section>
